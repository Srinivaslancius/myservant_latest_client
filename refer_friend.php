			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						...
						<input type="text" class="form-control"  name="user_full_name" placeholder="Enter a valid email address" required>
			            </div>
						</div>
						<div class="col-sm-3">
								</div>
					...
					<div class="form-group">
						<button class="button1" type="submit" name="save" style="font-size:16px;padding:0px 40px">Send Invite</button> 					
					</div>	
