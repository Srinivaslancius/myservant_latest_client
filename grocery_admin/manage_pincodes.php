                        ...
                        <table class="table table-striped table-bordered dataTable" id="table-2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span><a href="edit_lkp_pincodes.php?pincode_id=<?php echo $row['id']; ?>">edit</a>  &nbsp;<!-- <a href="delete.php?id=<?php echo $row['id']; ?>&table=<?php echo "grocery_lkp_pincodes" ?>"><i class="zmdi zmdi-delete zmdi-hc-fw" onclick="return confirm('Are you sure you want to delete?')"></i></a> --></span></td>
                                </tr>
                                <?php $i++; } ?>
                            </tbody>
                        </table>
