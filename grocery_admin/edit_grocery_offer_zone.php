                    ...
                    <div class="row">
                        ...
                        <form class="form-horizontal" method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <input class="start-date-pick form-control" data-format="yyyy-MM-dd" type="text" placeholder="Offer Start Date" name="offer_start_date" value="<?php echo $getOfferZones['offer_start_date']; ?>" required="required">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="form-control-3" class="col-sm-3 col-md-4 control-label">Offer End Date</label>
                                <div class="col-sm-6 col-md-4">
                                    <input class="end-date-pick form-control" data-format="yyyy-MM-dd" type="text" placeholder="Offer End Date" name="offer_end_date" value="<?php echo $getOfferZones['offer_end_date']; ?>" required="required">
                                </div>
                            </div>
                            <div class="form-group">
