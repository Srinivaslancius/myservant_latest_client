      ...
      <?php
        if (!isset($_POST['submit']))  {
          ...
          //echo "<pre>"; print_r($_POST); die;
            ...
            $sql = "UPDATE `grocery_coupons` SET coupon_code=UPPER('$coupon_code'), price_type_id='$price_type_id', discount_price='$discount_price', coupon_type='$coupon_type', coupon_start_date='$coupon_start_date', coupon_end_date='$coupon_end_date', category_id='$category_id', sub_category_id='$sub_category_id' WHERE id = '$id' ";
                        ...
                        <form class="form-horizontal" method="post" autocomplete="off">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <input type="text" style="text-transform:uppercase" name="coupon_code" class="form-control" id="user_input" onkeyup="checkUserAvailTest()"  placeholder="Enter Coupon Code" required value="<?php echo $getGroceryCouponsData['coupon_code'];?>">
