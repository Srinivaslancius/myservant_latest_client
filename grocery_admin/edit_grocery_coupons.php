                    ...
                    <div class="row">
                        ...
                        <form class="form-horizontal" method="post" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <input class="start-date-pick form-control" data-format="yyyy-MM-dd" type="text" placeholder="Coupon Start Date" name="coupon_start_date" required="required" value="<?php echo $getGroceryCouponsData['coupon_start_date'];?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="form-control-3" class="col-sm-3 col-md-4 control-label">Coupon End Date</label>
                                <div class="col-sm-6 col-md-4">
                                    <input class="end-date-pick form-control" data-format="yyyy-MM-dd" type="text" placeholder="Coupon End Date" name="coupon_end_date" required="required" value="<?php echo $getGroceryCouponsData['coupon_end_date'];?>">
                                </div>
                            </div>
                            <div class="form-group">
