...
<head>
 ...
 if (!isset($_POST['submit']))  {
    ...
    if($conn->query($sql) === TRUE){
       echo "<script type='text/javascript'>window.location='reward_points.php?msg=success'</script>";
    } else {
       echo "<script type='text/javascript'>window.location='reward_points.php?msg=fail'</script>";
    }
}
?>
