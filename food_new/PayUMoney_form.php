  ...
  <body onload="submitPayuForm()">
    ...
    <form action="<?php echo $action; ?>" method="post" name="payuForm" style="display:none">
      ...
      <table>
        ...
        <tr>
          <td>Success URI: </td>
          <td colspan="3"><input name="surl" value="https://palle2patnam.com/lancius/myservant/food_new/ordersuccess.php?odi=<?php echo $odi; ?>&pay_stau=1" size="64" /></td>
        </tr>
        <tr>
          <td>Failure URI: </td>
          <td colspan="3"><input name="furl" value="https://palle2patnam.com/lancius/myservant/food_new/orderfailure.php?odi=<?php echo $odi; ?>&pay_stau=3" size="64" /></td>
        </tr>
