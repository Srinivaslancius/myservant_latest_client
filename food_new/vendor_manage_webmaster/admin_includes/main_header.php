...
include_once('../../admin_includes/food_common_functions.php');
$getVendorData = getAllDataWhere('food_vendors','id',$_SESSION['food_vendor_user_id']); 
$getVendorDataIndiv = $getVendorData->fetch_assoc();

if(!isset($_SESSION['food_vendor_user_id'])) {
...
<html lang="en">  
  <head>
    ...
    <title><?php echo $getVendorDataIndiv['restaurant_name'];?></title>
    <link rel="icon" type="image/png" href="<?php echo $base_url . 'uploads/food_vendor_logo/'.$getVendorDataIndiv['logo'] ?>" sizes="32x32">    
      ...
      <nav class="navbar navbar-default" style="background-color:#D4E6F1 !important;">
        <div class="navbar-header">
          <a class="navbar-brand" href="dashboard.php">
            <img src="<?php echo $base_url . 'uploads/food_vendor_logo/'.$getVendorDataIndiv['logo'] ?>" accept="image/*" height="20">
            <span><?php echo $getVendorDataIndiv['restaurant_name'];?></span>
          </a>
            ...
            <ul class="nav navbar-nav navbar-right">              
              <li class="nav-table dropdown hidden-sm-down">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                  ...
                  <span class="nav-cell"><?php echo $_SESSION['food_vendor_user_name']; ?>
