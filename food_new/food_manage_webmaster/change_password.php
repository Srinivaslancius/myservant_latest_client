              ...
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form data-toggle="validator" method="POST" autocomplete="off">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" name="new_password" class="form-control" id="new_password" minlength="8" placeholder="*********" data-error="Please Enter Minimum 8 characters." required>
