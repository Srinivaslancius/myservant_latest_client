...
$id = $_GET['fid'];
 if (!isset($_POST['submit']))  {
      ...
      $lkp_status_id = $_POST['lkp_status_id'];
        ...
        $sql = "UPDATE `food_ingredients` SET ingredient_name = '$ingredient_name', lkp_status_id='$lkp_status_id' WHERE id = '$id' ";
...
<div class="site-content">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="row">
              <?php $getIngredients = getAllDataWhere('food_ingredients','id',$id);
              ...
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form data-toggle="validator" method="POST">
                  <div class="form-group">
                    ...
                    <input type="text" name="ingredient_name" class="form-control" id="ingredient_name" placeholder="Ingredient Name" data-error="Please enter Ingredient Name" required value="<?php echo $getIngredientsData['ingredient_name'];?>">
