              ...
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form data-toggle="validator" method="POST" autocomplete="off">
                  <div class="form-group">
                    ...
                    <input type="text" name="state_name" class="form-control" id="user_input" placeholder="State Name" data-error="Please enter State Name" required onkeyup="checkUserAvailTest()" value="<?php echo $getStatesData['state_name'];?>">
