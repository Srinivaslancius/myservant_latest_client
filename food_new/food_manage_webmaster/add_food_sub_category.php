...
if (!isset($_POST['submit']))  {
  ...
  if($fileToUpload!='') {
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
        $sql = "INSERT INTO food_sub_category (`food_category_id`, `sub_category_name`, `sub_category_description`,`sub_category_image`, `meta_title`, `meta_keywords`, `meta_desc`, `lkp_status_id`) VALUES ('$food_category_id', '$sub_category_name', '$sub_category_description','$fileToUpload', '$meta_title', '$meta_keywords', '$meta_desc', '$lkp_status_id')"; 
              ...
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form data-toggle="validator" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group" id="service_category_id">
                    ...
                    <select name="food_category_id" class="custom-select" data-error="This field is required." required>
