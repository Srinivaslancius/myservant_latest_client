...
<ul id="cat_nav">
       ...
       <li><a href="grocery_orders.php" class="<?php if($page_name == 'grocery_orders.php' || $page_name == 'order_details.php' ) { echo "active"; } ?>"><i class="icon-grocery-store"></i> Grocery Orders</a></li>
