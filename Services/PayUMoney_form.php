  ...
  <body onload="submitPayuForm()">
    ...
    <form action="<?php echo $action; ?>" method="post" name="payuForm" style="display:none">
      ...
      <table>
        ...
        <tr>
          <td>Success URI: </td>
          <td colspan="3"><input name="surl" value="<?php echo $base_url; ?>Services/ordersuccess.php?odi=<?php echo $odi; ?>&pay_stau=1" size="64" /></td>
        </tr>
        <tr>
          <td>Failure URI: </td>
          <td colspan="3"><input name="furl" value="<?php echo $base_url; ?>Services/orderfailure.php?odi=<?php echo $odi; ?>&pay_stau=3" size="64" /></td>
        </tr>
