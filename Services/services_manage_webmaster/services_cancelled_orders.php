...
<?php $i=1; $getServiceCancelledOrders = "SELECT * FROM services_orders WHERE lkp_order_status_id = 3 ";
$getServiceCancelledOrdersData = $conn->query($getServiceCancelledOrders);
  ?>
          ...
          <div class="panel-body">
            <div class="table-responsive">
              <table class="table table-striped table-bordered dataTable" id="table-1">
                ...
                <tbody>
                  <?php while ($row = $getServiceCancelledOrdersData->fetch_assoc()) { ?>
                  <tr>
                    <td><?php echo $i;?></td>
