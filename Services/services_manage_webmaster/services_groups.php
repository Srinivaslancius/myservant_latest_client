              ...
              <table class="table table-striped table-bordered dataTable" id="table-1">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td> <a href="edit_services_groups.php?gid=<?php echo $row['id']; ?>">edit</a> &nbsp; <a href="delete.php?id=<?php echo $row['id']; ?>&table=<?php echo "services_groups";?>"><i class="zmdi zmdi-delete zmdi-hc-fw" onclick="return confirm('Are you sure you want to delete?')"></i></a> &nbsp;
