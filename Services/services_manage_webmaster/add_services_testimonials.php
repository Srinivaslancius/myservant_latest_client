  ...
  if (!isset($_POST['submit']))  {
      ...
      if($fileToUpload!='' && $app_image!='') {
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file) && move_uploaded_file($_FILES["app_image"]["tmp_name"], $target_file1)) {
             $sql = "INSERT INTO services_testimonials (`title`,`email`,`phone_number`,`reason`, `description`, `image`,`app_image`, `lkp_status_id`, `created_at`) VALUES ('$title','$email','$phone_number','$reason', '$description','$fileToUpload','$app_image', 1, '$created_at')";
              ...
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form data-toggle="validator" method="POST" autocomplete="off" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <label class="btn btn-default file-upload-btn">
                      Choose file...
                        <input id="form-control-22" class="file-upload-input" type="file" accept="image/*" name="app_image" id="fileToUpload"  onchange="loadFile1(event)"  multiple="multiple" required>
                      </label> (width : 75px ; height : 75px)
                  </div>
                  <div class="form-group">
