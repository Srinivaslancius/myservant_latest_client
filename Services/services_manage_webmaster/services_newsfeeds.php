...
<?php $getAllNewsFeedurls = getAllDataWithActiveRecent('services_newsfeed'); $i=1; ?>
     <div class="site-content">
        <div class="panel panel-default panel-table">
          <div class="panel-heading">
            <a href="add_services_newsfeeds.php" style="float:right">Add News Feed</a>
            <h3 class="m-t-0 m-b-5">News Feed</h3>
          </div>
          <div class="panel-body">
            <div class="table-responsive">
              <table class="table table-striped table-bordered dataTable" id="table-1">
                ...
                <tbody>
                  <?php while ($row = $getAllNewsFeedurls->fetch_assoc()) { ?>
                  <tr>
                    <td><?php echo $i;?></td>
                    <td><?php echo $row['title'];?></td>
                    <td><?php echo $row['news_feed_url'];?></td>
                    <td><?php if ($row['lkp_status_id']==0) { echo "<span class='label label-outline-success check_active open_cursor' data-incId=".$row['id']." data-status=".$row['lkp_status_id']." data-tbname='services_newsfeed'>Active</span>" ;} else { echo "<span class='label label-outline-info check_active open_cursor' data-status=".$row['lkp_status_id']." data-incId=".$row['id']." data-tbname='services_newsfeed'>In Active</span>" ;} ?></td>
                    <td> <a href="edit_services_newsfeeds.php?bid=<?php echo $row['id']; ?>"><i class="zmdi zmdi-edit"></i></a>
