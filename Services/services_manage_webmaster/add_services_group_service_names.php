              ...
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form data-toggle="validator" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <select name="services_sub_category_id" id="services_sub_category_id" class="custom-select" data-error="This field is required." required onChange="getGroupsData(this.value);" data-plugin="select2" data-options="{ placeholder: 'Select a Sub Category', allowClear: true }">
                  ...
                  <div class="form-group">
                    ...
                    <select name="services_group_id" id="services_group_id" class="custom-select" data-error="This field is required." required data-plugin="select2" data-options="{ placeholder: 'Select a Service Group', allowClear: true }">
