              ...
              <table class="table table-striped table-bordered dataTable" id="table-1">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td> <a href="edit_services_sub_category.php?sid=<?php echo $row['id']; ?>">edit</a> &nbsp; <a href="delete_services_sub_category.php?sid=<?php echo $row['id']; ?>"><i class="zmdi zmdi-delete zmdi-hc-fw" onclick="return confirm('Are you sure you want to delete?')"></i></a> &nbsp;
