...
<?php $getSubCategoriesData = getAllDataWithActiveRecent('services_sub_category'); $i=1; ?>
     <div class="site-content">
        <div class="panel panel-default panel-table">
          <div class="panel-heading">
            <a href="add_services_sub_category.php" style="float:right">Add Sub Categories</a>
              ...
              <table class="table table-striped table-bordered dataTable" id="table-1">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php if ($row['lkp_status_id']==0) { echo "<span class='label label-outline-success check_active open_cursor' data-incId=".$row['id']." data-status=".$row['lkp_status_id']." data-tbname='services_sub_category'>Active</span>" ;} else { echo "<span class='label label-outline-info check_active open_cursor' data-status=".$row['lkp_status_id']." data-incId=".$row['id']." data-tbname='services_sub_category'>In Active</span>" ;} ?></td>
                    <td> <a href="edit_services_sub_category.php?sid=<?php echo $row['id']; ?>"><i class="zmdi zmdi-edit"></i></a> &nbsp; <a href="delete_services_sub_category.php?sid=<?php echo $row['id']; ?>"><i class="zmdi zmdi-delete zmdi-hc-fw" onclick="return confirm('Are you sure you want to delete?')"></i></a> &nbsp;
                        ...
                        <div class="modal-content animated flipInX">
                          ...
                          <div class="modal-body" id="modal_body">
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-6"><img src="<?php echo $base_url . 'uploads/services_sub_category_images/'.$row['sub_category_image'] ?>" height="100" width="100"/></div>
                            </div>
                            <div class="row">
                              <div class="col-sm-2"></div>
