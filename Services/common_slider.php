...
?>
	...
	<div class="ls-slide" data-ls="slidedelay: 1500; transition2d:5;">
			<img title="Services" src="<?php echo $base_url . 'uploads/services_banner_images/'.$getBannerData['banner'] ?>" style="width:100%; height:400px;" class="ls-bg" alt="<?php echo $getBannerData['title'];?>" >
		</div>
	<?php } ?>
</div>