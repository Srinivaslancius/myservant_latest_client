...
<ul id="cat_nav">
       ...
       <li><a href="grocery_orders1.php" class="<?php if($page_name == 'grocery_orders1.php' || $page_name == 'view_grocery_order_details.php') { echo "active"; } ?>"><i class="icon-grocery-store"></i> Grocery Orders</a></li>
