							...
							<div class="tracking-content">
								<form action="#" method="get" accept-charset="utf-8">
									<div class="one-half order-id">
										...
										<input type="text" id="order-id" name="order-id" placeholder="Found your order confirmation email">
									</div><!-- /.one-half order-id -->
									<div class="one-half billing">
										<label for="billing">Billing Email</label>
										<input type="text" id="billing" name="billing" placeholder="Found your order confirmation email">
