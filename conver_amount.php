...
$transaction = "INSERT INTO `grocery_reward_transactions` (`user_id`,`transation_status`,`reward_points`,`transanction_amount`) VALUES ('".$_SESSION['user_login_session_id']."','$transation_status1,'$reward_points','$total_amount');"
